...
class TestDrugData:
    ...
    def test_drug_data_contains_drug_targets(self, sample_drug_data):
    ...
    def test_drug_data_empty_targets(self):
    ...
    def test_approved_disease_ids_returns_phase_4_only(self, sample_drug_data):
    ...
    def test_investigated_disease_ids_returns_all(self, sample_drug_data):
    ...
    def test_approved_disease_ids_empty_when_no_indications(self):
    ...
    def test_investigated_disease_ids_empty_when_no_indications(self):
